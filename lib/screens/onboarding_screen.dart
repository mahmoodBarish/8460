      ...
      body: Stack(
        children: [
          ...
          Positioned(
            ...
            left: 0,
            right: 0,
            // The image's absoluteRenderBounds height is 536px for a 812px screen.
          ...
          // This positioned widget covers the area from y=452px to the bottom of the screen.
          Positioned(
              ...
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  ...
                  colors: [
                    ...
                    Colors.black.withOpacity(0.7), // Figma gradient stop at 0.2367 position. Opacity at this point matches the dark feel.
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 32), // Spacing before button derived from Figma
                      // "Get Started" Button
                      SizedBox(
                      ...
                      SizedBox(
                        height: screenHeight * 0.03, // Responsive bottom padding after the button, adjust as needed
                      ),
                    ],
                  ),
                ),
          ...
          // Note: The Figma Home Indicator (ID 156:103) is typically a system UI element.
          // By using SafeArea, we ensure content doesn't overlap with it.
          // Explicitly drawing it with a dark color on a black background would make it barely visible.
          // Therefore, relying on system rendering and SafeArea is preferred.
        ],
      ),
    );
  }
